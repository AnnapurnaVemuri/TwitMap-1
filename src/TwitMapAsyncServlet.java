...
public class TwitMapAsyncServlet extends TwitMap {
	...
	public ArrayList<String> readFromList() {
	...
	private boolean isMessageSignatureValid(SNSMessage msg) {
		...
		try {
			...
			return sig.verify(Base64
					.decodeBase64(msg.getSignature().getBytes()));
		} catch (Exception e) {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse res)
		...
		// BasicAWSCredentials(AwsCredentialConstants.ACCESS.getValue(),AwsCredentialConstants.SECRET.getValue());
		...
		if (messagetype.equals("Notification")) {
			...
			String logMsgAndSubject = "";// ">>Notification received from topic "
											// + msg.getTopicArn();
			/*
			 * if (msg.getSubject() != null) logMsgAndSubject += " Subject: " +
			 * msg.getSubject();
			 */
			logMsgAndSubject += msg.getMessage();
			String mes = msg.getMessage();
			Random r = new Random();
			// LatLong ll=new LatLong(r.nextInt(50),r.nextInt(50));
			// logMsgAndSubject=ll.toString();
			System.out.println(logMsgAndSubject);
			this.addtoList(logMsgAndSubject);
		}
	...
	public void doGet(HttpServletRequest request, HttpServletResponse res)
		...
		List<String> locations = new LinkedList<String>();// getTweets.getLocationsFromDB(keyword);
		Random r = new Random();
		// LatLong ll=new LatLong(r.nextInt(50),r.nextInt(50));
		String locationList = "";
		List<String> list = readFromList();
		locations.addAll(list);
		for (String location : locations) {
			locationList += location;
			locationList += "\n\n";
		}
		String msg="data: " + locationList;
